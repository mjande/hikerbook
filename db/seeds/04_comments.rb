...
grand_canyon.comments.create(user: mary,
                             body: "I've been meaning to get out there for a while. Glad you had a good time!")
grand_canyon.comments.create(user: shawn, body: 'Looks great. Where did you stay while you were down there?')
grand_canyon.comments.create(user: james,
                             body: 'We stayed at the North Rim Campground. It was close to some great trails and very well maintained.')
...
yosemite.comments.create(user: lauren,
                         body: 'Wow that pic is incredible! We went up last summer, but I want to go back to see those beautiful fall colors.')
